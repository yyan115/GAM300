...
public:
	...
	virtual bool LoadResource(const std::string& resourcePath, const std::string& assetPath = "") { resourcePath;  return true; }
	virtual bool ReloadResource(const std::string& resourcePath, const std::string& assetPath = "") { assetPath;  return true; }
