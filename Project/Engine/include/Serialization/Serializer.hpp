...
public:
    ...
    static Entity DeserializeEntity(ECSManager& ecs, const rapidjson::Value& entObj, bool isPrefab = false, Entity entity = INVALID_ENTITY, bool skipSpawnChildren = false, bool initialiseAnimation = true);
