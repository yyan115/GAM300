...
bool Engine::Initialize() {
...
#if 1
	{
        ...
        std::cout << "=== Running reflection + serialization single-main test for Transform ===\n";
        ...
        if (!td) {
            std::cout << "FAIL: TypeResolver<Transform>::Get() returned null. Ensure REFL_REGISTER_START(Transform) is compiled & linked.\n";
            reflection_ok = false;
        }
        else {
