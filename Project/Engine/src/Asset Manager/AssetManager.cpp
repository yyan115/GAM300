...
void AssetManager::UnloadAsset(const std::string &assetPath)
{
	...
	if (it != assetMetaMap.end())
	{
		...
		std::cout << "[AssetManager] Unloaded asset: " << assetPath << std::endl
				  << std::endl;
	}
}
...
void AssetManager::CompileAllAssetsForAndroid()
{
	...
	std::cout << "[AssetManager] Finished compiling assets for Android. Android Resources folder is in GAM300/AndroidProject/app/src/main/assets/Resources" << std::endl
			  << std::endl;
}
...
void AssetManager::CompileAllAssetsForDesktop()
{
	...
	std::cout << "[AssetManager] Finished compiling assets for Desktop." << std::endl
			  << std::endl;
}
