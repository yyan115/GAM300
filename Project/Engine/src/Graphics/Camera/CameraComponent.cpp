...
REFL_REGISTER_START(CameraComponent)
	...
	// Directional Blur
	REFL_REGISTER_PROPERTY(dirBlurEnabled)
	REFL_REGISTER_PROPERTY(dirBlurIntensity)
	REFL_REGISTER_PROPERTY(dirBlurStrength)
	REFL_REGISTER_PROPERTY(dirBlurAngle)
	REFL_REGISTER_PROPERTY(dirBlurSamples)
