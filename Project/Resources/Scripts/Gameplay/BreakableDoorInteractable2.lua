...
return Component {
    ...
    Start = function(self)
        ...
        if not _G.BreakableDoorRegistry_D45     then _G.BreakableDoorRegistry_D45     = {} end
        if not _G.BreakableDoorGroupBroken_D45  then _G.BreakableDoorGroupBroken_D45  = {} end
        _G.BreakableDoorRegistry_D45[self._doorName] = self
        ...
        if _G.BreakableDoorGroupBroken_D45[self._groupKey] == nil then
            _G.BreakableDoorGroupBroken_D45[self._groupKey] = false
        end
    ...
    OnDisable = function(self)
        ...
        self._endpointPos  = nil
        self._endpointPrev = nil
        if _G.chain_retract_veto_D45 ~= nil then _G.chain_retract_veto_D45 = nil end
        if _G.BreakableDoorRegistry_D45 then
            _G.BreakableDoorRegistry_D45[self._doorName] = nil
        end
    ...
    _applyMashStep = function(self, step)
        ...
        if linkedName ~= "" then
            local linked = _G.BreakableDoorRegistry_D45 and _G.BreakableDoorRegistry_D45[linkedName]
            if linked then
                pcall(function()
    ...
    -- Guarded by _G.BreakableDoorGroupBroken_D45 so only one instance runs it once per group.
    -- =========================================================================

    _doFinalMash = function(self)
        if _G.BreakableDoorGroupBroken_D45[self._groupKey] then
            --print("[BreakableDoor] Already broken — skipping duplicate final mash")
            return
        end
        _G.BreakableDoorGroupBroken_D45[self._groupKey] = true
        _G.chain_retract_veto_D45   = nil
    ...
    _onEndpointMoved = function(self, payload)
        if _G.BreakableDoorGroupBroken_D45[self._groupKey] then return end
        if self._mashDone          then return end
        ...
        self._mashProgress = 0
        self._mashDone     = false
        _G.chain_retract_veto_D45 = function()
