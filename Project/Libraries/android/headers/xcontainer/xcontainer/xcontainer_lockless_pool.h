...
namespace xcontainer::pool
{
    namespace details
    {
        ...
        public:     using                                           allocator   = T_ALLOCATOR;
        public:
        ...
        public:
            ...
            constexpr   const value_type&       getEntryByIndex     (const T1 Index)           const   noexcept { return m_Allocator[Index]; }
            template< typename T2 >
            inline      value_type&             getEntryByIndex     (const T2 Index)                   noexcept { return m_Allocator[Index]; }
    ...
    //------------------------------------------------------------------------------
    template< typename T >
    class mpmc_bounded_dynamic : public details::mpmc_bounded_general< T, xcontainer::unique_ptr<T[]> >
    {
    public:

        using parent        = details::mpmc_bounded_general< T, xcontainer::unique_ptr<T[]> >;
    ...
    template< typename T >
    class mpmc_bounded_dynamic_jitc : public details::mpmc_bounded_jitc_general< T, details::my_unique_raw_ptr<T> >
    {
    public:

        using parent        = details::mpmc_bounded_jitc_general< T, details::my_unique_raw_ptr<T> >;
    ...
    using mpmc_bounded_jitc =
        details::mpmc_bounded_jitc_general<
        T,
        typename xcontainer::container_static_to_dynamic<
        xcontainer::raw_array, T_MAX_SIZE
        >::template type<T>
        >; }
#endif